...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, isMobileOpen, setIsCollapsed, setIsMobileOpen }) => {
  ...
  return (
    <aside className={clsx(
      ...
      {/* Logo */}
      <div className={clsx("px-8 mb-10 text-white font-bold text-xl tracking-wide flex items-center transition-all", isCollapsed && "px-0 justify-center")}>
        ...
        <div className={clsx(
          ...
          {!isCollapsed && (
            <div className="flex flex-col whitespace-nowrap">
              ...
              <span className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Verified Node</span>
            </div>
          )}
        </div>
      </div>
