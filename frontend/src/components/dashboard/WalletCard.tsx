    ...
    <Card className="flex flex-col h-full bg-[#18191d] border-slate-800/60" hoverEffect={false}>
      <div className="flex flex-col mb-8">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">NETWORK CONNECTED</span>
        ...
        <div className="flex items-center gap-2">
          ...
          {state.isConnected && (
            copied 
              ...
              : <Copy size={16} className="text-slate-500 hover:text-white cursor-pointer transition-colors" onClick={handleCopy} />
          )}
        </div>
      </div>
      ...
      <div className="mt-auto pt-4">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-5xl font-bold text-[#a3ddff] tracking-tight">{state.balance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
