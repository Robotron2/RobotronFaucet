...
export const TotalSupplyCard: React.FC = () => {
	...
	return (
		<Card
			className="flex flex-col h-full bg-[#18191d] border-slate-800/60 relative overflow-hidden p-8"
			hoverEffect={false}>
			...
			<div className="relative z-10 flex flex-col h-full">
				...
				<div className="mt-auto w-full">
					...
					<p className="text-[10px] text-slate-400 font-medium tracking-wide">
						{percentage}% of Max Supply Minted
					</p>
				</div>
			</div>
		</Card>
...
export const MaxSupplyCard: React.FC = () => {
	return (
		<Card
			className="flex flex-col h-full justify-between bg-[#111415] border-[#00E676]/30 shadow-[0_0_20px_rgba(0,230,118,0.03)] p-8"
			hoverEffect={false}>
			<div>
